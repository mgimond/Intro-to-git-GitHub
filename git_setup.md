...
Bring up the git shell (this may be listed as the **Git Bash** application on your computer). You can also access the shell from inside **RStudio** by clicking on the **Terminal** tab in the lower left-hand pane.
